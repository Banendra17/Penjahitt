...
namespace Penjahit
{
    class Program
    {
        ...
        {
            SqlConnection cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + "C: \\Users\\M S I\\Documents\\Penjahit - main\\Penjahit\\DatabaseJ.mdf" + ";Integrated Security=True");
            cn.Open();
            string User, Id;
            Console.WriteLine("Masukan Nama dan Id");
            User = Console.ReadLine();
            Id = Console.ReadLine();
            SqlCommand cmd = new SqlCommand("insert into tbLogin values('" + User + "', '" + Id + "')", cn);
